              ...
              footer: Padding(
                ...
                child: Container(
                  child: ListTile(
                    ...
                    title: Row(
                      children: <Widget>[
                        Expanded(child: Text('\$${this.widget.product.price - this.widget.product.discount}', style: TextStyle(color: Colors.redAccent, fontSize: 20, fontWeight: FontWeight.bold),)),
